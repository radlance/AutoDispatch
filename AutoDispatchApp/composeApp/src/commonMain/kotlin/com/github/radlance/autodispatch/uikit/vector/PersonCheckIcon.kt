...
val PersonCheckIcon: ImageVector
    get() {
        if (_PersonCheckIcon != null) {
            return _PersonCheckIcon!!
        }
        _PersonCheckIcon = ImageVector.Builder(
...
private var _PersonCheckIcon: ImageVector? = null
