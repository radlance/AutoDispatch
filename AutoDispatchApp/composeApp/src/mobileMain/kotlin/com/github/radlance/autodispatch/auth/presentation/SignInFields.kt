...
import autodispatch.composeapp.generated.resources.log_in_to_app
...
fun SignInFields(
    ...
    Card(modifier = modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(18.dp)) {
            Text(text = stringResource(Res.string.welcome), fontSize = 18.sp)
            Spacer(Modifier.height(4.dp))
            Text(
                text = stringResource(Res.string.log_in_to_app),
                fontSize = 14.sp,
