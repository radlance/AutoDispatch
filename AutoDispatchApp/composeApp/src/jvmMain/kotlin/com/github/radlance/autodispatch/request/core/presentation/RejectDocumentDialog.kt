...
@Composable
fun RejectDocumentDialog(
    onDismissRequest: () -> Unit,
    onReject: (String) -> Unit,
    rejectState: FetchResultUiState<Unit, String>,
    modifier: Modifier = Modifier
) {
    var rejectionReasonFieldValue by remember { mutableStateOf("") }
    val isLoading = rejectState is FetchResultUiState.Loading
    val error = (rejectState as? FetchResultUiState.Error<String>)?.error
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(
                onClick = { onReject(rejectionReasonFieldValue) },
