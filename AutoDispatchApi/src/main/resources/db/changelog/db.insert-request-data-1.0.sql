...
VALUES
    (3, 1, 1, 2, 'Склад №1, Москва, ул. Ленина, 10', 55.7054, 37.7258, 'Склад №3, Санкт-Петербург, пр. Невский, 25',
    ...
    (3, 3, 6, 5, 'Терминал №2, Казань, ул. Победы, 8', 55.7485, 49.1021, 'Терминал №1, Нижний Новгород, ул. Лесная, 18',
    ...
    (3, 1, 4, 13, 'Завод "МеталлПром", Екатеринбург', 56.7312, 60.7435, 'Склад "ПермТорг", Пермь',
    ...
    (3, 3, 3, 8, 'Склад №4, Новосибирск', 54.9415, 82.9034, 'Гипермаркет "ОмскМаркет", Омск',
    ...
    (3, 5, 10, 16, 'Склад №5, Ростов-на-Дону', 47.2411, 39.6238, 'Склад №2, Краснодар',
    ...
    (3, 1, 1, 6, 'Склад "Техно", Москва', 55.6543, 37.6341, 'Логистический центр "КазаньТранс"',
    ...
    (3, 1, 9, 52, 'Склад №1, Самара', 53.2015, 50.2518, 'Аптека №45, Саратов',
    ...
    (3, 1, 14, 53, 'Фабрика "ТекстильПром", Воронеж', 51.6325, 39.1248, 'Склад-магазин "БелТекстиль", Белгород',
    ...
    (3, 1, 1, 54, 'Склад №9, Москва', 55.4312, 37.5541, 'ТЦ "ТулаМебель", Тула',
    ...
    (3, 1, 31, 55, 'Склад Южный, Сочи', 43.5981, 39.7512, 'Порт Владивосток',
    ...
    (3, 1, 2, 7, 'Склад "Север", Санкт-Петербург', 59.9343, 30.3351, 'Склад "Волга", Волгоград',
    ...
    (3, 1, 11, 12, 'Логистический центр "Урал", Челябинск', 55.1644, 61.4368, 'Склад "БашЛогистик", Уфа',
     54.7351, 55.9587, 6, 1800.0, 12.5, 'Медоборудование и расходники', 10, 'REQ012',
     CURRENT_TIMESTAMP + interval '2 day' + interval '8 hour',
     CURRENT_TIMESTAMP + interval '3 day' + interval '15 hour'),

    (3, 1, 15, 17, 'Склад "ЛипецкПром"', 52.6031, 39.5708, 'Склад "ТамбовТорг"',
    ...
    (3, 1, 18, 19, 'Склад "ЯрославльСнаб"', 57.6261, 39.8845, 'Склад "КостромаМаркет"',
     57.7677, 40.9264, 1, 900.0, 8.0, 'Компьютерные комплектующие', 1, 'REQ014',
     CURRENT_TIMESTAMP + interval '1 day' + interval '13 hour',
     CURRENT_TIMESTAMP + interval '2 day' + interval '11 hour'),

    (3, 1, 20, 21, 'Склад "ПензаЛогистик"', 53.2007, 45.0046, 'Склад "СаранскТорг"',
    ...
    (3, 1, 22, 23, 'Склад "ТюменьТранс"', 57.1530, 65.5343, 'Склад "КурганСклад"',
     55.4443, 65.3162, 3, 2100.0, 18.0, 'Продукты питания (охлаждение)', 7, 'REQ016',
     CURRENT_TIMESTAMP + interval '2 day' + interval '6 hour',
     CURRENT_TIMESTAMP + interval '3 day' + interval '12 hour'),

    (3, 1, 24, 25, 'Склад "БарнаулСнаб"', 53.3489, 83.7764, 'Склад "ТомскЛогистик"',
    ...
    (3, 1, 26, 27, 'Склад "КировОпт"', 58.6036, 49.6679, 'Склад "ИжевскЛайн"',
    ...
    (3, 1, 28, 29, 'Склад "РязаньПром"', 54.6292, 39.7364, 'Склад "КалугаЛогистик"',
     54.5138, 36.2612, 6, 1400.0, 11.0, 'Медицинские расходники', 10, 'REQ019',
     CURRENT_TIMESTAMP + interval '2 day' + interval '10 hour',
     CURRENT_TIMESTAMP + interval '3 day' + interval '16 hour'),

    (3, 1, 30, 32, 'Склад "АрхангельскСнаб"', 64.5393, 40.5150, 'Склад "МурманскПорт"',
